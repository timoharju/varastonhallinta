 ...
 * @author tanel
 */
public abstract class FXMLController2 implements Initializable, Searchable, Modifiable, Creatable, Deletable{
    ...
    private static FXMLController2 activeController;
     ...
     */
    public static FXMLController2 getActiveController() {
     ...
     */
    public static void setActiveController(FXMLController2 activeController) {
        System.out.println("Set active controller " + activeController);
        FXMLController2.activeController = activeController;
    }
